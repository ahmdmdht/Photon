...
final Color primaryColor = Color(0xffF49800);
final Color correctAnswerColor = Color(0xff00ff00);
final Color wrongAnswerColor = Color(0xffED4337);
...
final Color darkPrimaryColor = Color(0xffF49800);
