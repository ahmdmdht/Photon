...
class _MenuScreenState extends State<MenuScreen> {
  ...
  void initState() {
    ...
    if (widget.isGuest) {
      menuName.removeWhere((element) => element == "logoutLbl");
      menuIcon.removeWhere((element) => element == "logout_icon.svg");
  ...
  void _onPressed(String index) {
    if (index == "notificationLbl") {
      ...
      if (widget.isGuest) {
        Navigator.of(context).pushNamed(Routes.coinStore, arguments: true);
      } else {
        Navigator.of(context).pushNamed(Routes.coinStore, arguments: false);
      }
    } else if (index == "theme") {
